...
\title{A Multiarmed Bandit Incentive Mechanism for\\ Crowdsourcing Task Allocation in cellular Network}
%
%
...
% PRIOR to the title within\cite{} the \IEEEtitleabstractindextext IEEEtran
...
\begin{IEEEkeywords}
Task Allocation, multiarmed bandits, mobile social network, reward maximization
\end{IEEEkeywords}}
...
%I wish you the best of succe%ss.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%5%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\hfill mds
...
\setlength{\parindent}{2em}The regret of strategy $\pi$ at time t is defined as follows:
\begin{equation}
...
\emph{\textbf{Definition 2} Dominant Strategy Incentive Compatibility(DSIC):} Mechanism $M$ is said to be DSIC if truth telling is a dominant strategy for all the workers. Formally,
%table
%\begin{tabular}{c|c}
%\toprule
%title&meaning\\
